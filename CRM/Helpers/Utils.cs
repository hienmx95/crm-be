...
namespace CRM.Helpers
{
    public static class Utils
    {
        ...
        public static long ConvertSLATimeToMenute(long Time, long SLATimeUnitId)
        {
            if (SLATimeUnitId == SLATimeUnitEnum.HOURS.Id)
                return (Time * 60);
            else if (SLATimeUnitId == SLATimeUnitEnum.DAY.Id)
                return (Time * 24 * 60);
            else
                return Time;
        }
