...
namespace CRM.Repositories
{
    public interface IDirectSalesOrderPromotionRepository
    {
        ...
        Task<List<DirectSalesOrderPromotion>> List(List<long> Ids);
    ...
    public class DirectSalesOrderPromotionRepository : IDirectSalesOrderPromotionRepository
    {
        ...
        private IQueryable<DirectSalesOrderPromotionDAO> OrFilter(IQueryable<DirectSalesOrderPromotionDAO> query, DirectSalesOrderPromotionFilter filter)
        {
            ...
            foreach (DirectSalesOrderPromotionFilter DirectSalesOrderPromotionFilter in filter.OrFilter)
            {
                ...
                if (DirectSalesOrderPromotionFilter.Id != null && DirectSalesOrderPromotionFilter.Id.HasValue)
                    queryable = queryable.Where(q => q.Id, DirectSalesOrderPromotionFilter.Id);
                if (DirectSalesOrderPromotionFilter.DirectSalesOrderId != null && DirectSalesOrderPromotionFilter.DirectSalesOrderId.HasValue)
                    queryable = queryable.Where(q => q.DirectSalesOrderId, DirectSalesOrderPromotionFilter.DirectSalesOrderId);
                if (DirectSalesOrderPromotionFilter.ItemId != null && DirectSalesOrderPromotionFilter.ItemId.HasValue)
                    queryable = queryable.Where(q => q.ItemId, DirectSalesOrderPromotionFilter.ItemId);
                if (DirectSalesOrderPromotionFilter.UnitOfMeasureId != null && DirectSalesOrderPromotionFilter.UnitOfMeasureId.HasValue)
                    queryable = queryable.Where(q => q.UnitOfMeasureId, DirectSalesOrderPromotionFilter.UnitOfMeasureId);
                if (DirectSalesOrderPromotionFilter.Quantity != null && DirectSalesOrderPromotionFilter.Quantity.HasValue)
                    queryable = queryable.Where(q => q.Quantity, DirectSalesOrderPromotionFilter.Quantity);
                if (DirectSalesOrderPromotionFilter.PrimaryUnitOfMeasureId != null && DirectSalesOrderPromotionFilter.PrimaryUnitOfMeasureId.HasValue)
                    queryable = queryable.Where(q => q.PrimaryUnitOfMeasureId, DirectSalesOrderPromotionFilter.PrimaryUnitOfMeasureId);
                if (DirectSalesOrderPromotionFilter.RequestedQuantity != null && DirectSalesOrderPromotionFilter.RequestedQuantity.HasValue)
                ...
                if (DirectSalesOrderPromotionFilter.Factor != null && DirectSalesOrderPromotionFilter.Factor.HasValue)
                    queryable = queryable.Where(q => q.Factor.HasValue).Where(q => q.Factor, DirectSalesOrderPromotionFilter.Factor);
                ...
                case OrderType.ASC:
                    switch (filter.OrderBy)
                    {
                        ...
                        case DirectSalesOrderPromotionOrder.Note:
                            ...
                            break;
                        case DirectSalesOrderPromotionOrder.Factor:
        ...
        public async Task<List<DirectSalesOrderPromotion>> List(List<long> Ids)
        {
            List<DirectSalesOrderPromotion> DirectSalesOrderPromotions = await DataContext.DirectSalesOrderPromotion.AsNoTracking()
            .Where(x => Ids.Contains(x.Id)).Select(x => new DirectSalesOrderPromotion()
            {
                Id = x.Id,
