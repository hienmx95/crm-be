...
{
    public class Customer_TicketSourceDTO : DataDTO
    {
        ...
        public Customer_TicketSourceDTO() {}
        public Customer_TicketSourceDTO(TicketSource TicketSource)
        {
    ...
    public class Customer_TicketSourceFilterDTO : FilterDTO
    {
