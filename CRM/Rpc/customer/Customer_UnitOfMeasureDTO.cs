...
{
    public class Customer_UnitOfMeasureDTO : DataDTO
    {
        ...
        public Customer_UnitOfMeasureDTO() {}
        public Customer_UnitOfMeasureDTO(UnitOfMeasureGroupingContent UnitOfMeasureGroupingContent)
        {
    ...
    public class Customer_UnitOfMeasureFilterDTO : FilterDTO
    {
