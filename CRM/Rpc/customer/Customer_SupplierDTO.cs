...
{
    public class Customer_SupplierDTO : DataDTO
    {
        ...
        public Customer_SupplierDTO() {}
        public Customer_SupplierDTO(Supplier Supplier)
        {
    ...
    public class Customer_SupplierFilterDTO : FilterDTO
    {
