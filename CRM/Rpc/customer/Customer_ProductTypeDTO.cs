...
{
    public class Customer_ProductTypeDTO : DataDTO
    {
        ...
        public Customer_ProductTypeDTO() {}
        public Customer_ProductTypeDTO(ProductType ProductType)
        {
    ...
    public class Customer_ProductTypeFilterDTO : FilterDTO
    {
