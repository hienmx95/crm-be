...
{
    public class Customer_CallEmotionDTO : DataDTO
    {
        ...
        public Customer_CallEmotionDTO() {}
        public Customer_CallEmotionDTO(CallEmotion CallEmotion)
        {
    ...
    public class Customer_CallEmotionFilterDTO : FilterDTO
    {
