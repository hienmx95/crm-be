...
{
    public class Customer_ContactStatusDTO : DataDTO
    {
        ...
        public Customer_ContactStatusDTO() { }
        public Customer_ContactStatusDTO(ContactStatus ContactStatus)
        {
    ...
    public class Customer_ContactStatusFilterDTO : FilterDTO
    {
