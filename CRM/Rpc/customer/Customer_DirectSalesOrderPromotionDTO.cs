...
{
    public class Customer_DirectSalesOrderPromotionDTO : DataDTO
    {
        ...
        public Customer_DirectSalesOrderPromotionDTO() { }
        public Customer_DirectSalesOrderPromotionDTO(DirectSalesOrderPromotion DirectSalesOrderPromotion)
        {
            ...
            this.Item = DirectSalesOrderPromotion.Item == null ? null : new Customer_ItemDTO(DirectSalesOrderPromotion.Item);
            this.PrimaryUnitOfMeasure = DirectSalesOrderPromotion.PrimaryUnitOfMeasure == null ? null : new Customer_UnitOfMeasureDTO(DirectSalesOrderPromotion.PrimaryUnitOfMeasure);
            this.UnitOfMeasure = DirectSalesOrderPromotion.UnitOfMeasure == null ? null : new Customer_UnitOfMeasureDTO(DirectSalesOrderPromotion.UnitOfMeasure);
            this.Errors = DirectSalesOrderPromotion.Errors;
        }
    }

    public class Customer_DirectSalesOrderPromotionFilterDTO : FilterDTO
    {
