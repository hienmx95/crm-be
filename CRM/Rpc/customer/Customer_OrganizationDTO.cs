...
{
    public class Customer_OrganizationDTO : DataDTO
    {
        ...
        public Customer_OrganizationDTO() {}
        public Customer_OrganizationDTO(Organization Organization)
        {
    ...
    public class Customer_OrganizationFilterDTO : FilterDTO
    {
