...
{
    public class Customer_DirectSalesOrderContentDTO : DataDTO
    {
        ...
        public Customer_DirectSalesOrderContentDTO() { }
    ...
    public class Customer_DirectSalesOrderContentFilterDTO : FilterDTO
    {
