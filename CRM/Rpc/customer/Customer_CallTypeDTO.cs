...
{
    public class Customer_CallTypeDTO : DataDTO
    {
        ...
        public Customer_CallTypeDTO() {}
        public Customer_CallTypeDTO(CallType CallType)
        {
    ...
    public class Customer_CallTypeFilterDTO : FilterDTO
    {
