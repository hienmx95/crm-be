...
{
    public class Customer_NationDTO : DataDTO
    {
        ...
        public Customer_NationDTO() {}
        public Customer_NationDTO(Nation Nation)
        {
    ...
    public class Customer_NationFilterDTO : FilterDTO
    {
