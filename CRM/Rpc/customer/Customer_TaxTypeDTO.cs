...
{
    public class Customer_TaxTypeDTO : DataDTO
    {
        ...
        public Customer_TaxTypeDTO() {}
        public Customer_TaxTypeDTO(TaxType TaxType)
        {
    ...
    public class Customer_TaxTypeFilterDTO : FilterDTO
    {
