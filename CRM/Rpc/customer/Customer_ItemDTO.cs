...
{
    public class Customer_ItemDTO : DataDTO
    {
        ...
        public Customer_ItemDTO() { }
        public Customer_ItemDTO(Item Item)
        {
            ...
            this.Product = Item.Product == null ? null : new Customer_ProductDTO(Item.Product);

            this.Errors = Item.Errors;
        }
    }

    public class Customer_ItemFilterDTO : FilterDTO
    {
