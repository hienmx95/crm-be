...
{
    public class Customer_CompanyDTO : DataDTO
    {
        ...
        public Customer_CompanyDTO() {}
        public Customer_CompanyDTO(Company Company)
        {
    ...
    public class Customer_CompanyFilterDTO : FilterDTO
    {
