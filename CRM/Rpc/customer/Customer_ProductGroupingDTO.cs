...
{
    public class Customer_ProductGroupingDTO : DataDTO
    {
        ...
        public Customer_ProductGroupingDTO() { }
        public Customer_ProductGroupingDTO(ProductGrouping ProductGrouping)
        {
    ...
    public class Customer_ProductGroupingFilterDTO : FilterDTO
    {
