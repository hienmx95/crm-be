...
{
    public class TicketGroup_TicketTypeDTO : DataDTO
    {
        ...
        public TicketGroup_TicketTypeDTO() {}
        public TicketGroup_TicketTypeDTO(TicketType TicketType)
        {
    ...
    public class TicketGroup_TicketTypeFilterDTO : FilterDTO
    {
