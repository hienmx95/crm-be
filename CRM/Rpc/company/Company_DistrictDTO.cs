...
{
    public class Company_DistrictDTO : DataDTO
    {
        ...
        public Company_DistrictDTO() {}
        public Company_DistrictDTO(District District)
        {
    ...
    public class Company_DistrictFilterDTO : FilterDTO
    {
