...
{
    public class Company_SmsQueueDTO : DataDTO
    {
        ...
        public Company_AppUserDTO SentByAppUser { get; set; }
        public Company_SmsQueueStatusDTO SmsQueueStatus { get; set; }
        ...
        public Company_SmsQueueDTO() { }
        public Company_SmsQueueDTO(SmsQueue SmsQueue)
        {
            this.Id = SmsQueue.Id;
            ...
            this.SentByAppUser = SmsQueue.SentByAppUser == null ? null : new Company_AppUserDTO(SmsQueue.SentByAppUser);
            this.SmsQueueStatus = SmsQueue.SmsQueueStatus == null ? null : new Company_SmsQueueStatusDTO(SmsQueue.SmsQueueStatus);
    ...
    public class Company_SmsQueueFilterDTO : FilterDTO
    {
