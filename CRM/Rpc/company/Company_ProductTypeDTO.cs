...
{
    public class Company_ProductTypeDTO : DataDTO
    {
        ...
        public Company_ProductTypeDTO() {}
        public Company_ProductTypeDTO(ProductType ProductType)
        {
    ...
    public class Company_ProductTypeFilterDTO : FilterDTO
    {
