...
{
    public class Company_UnitOfMeasureDTO : DataDTO
    {
        ...
        public Company_UnitOfMeasureDTO() {}
        public Company_UnitOfMeasureDTO(UnitOfMeasureGroupingContent UnitOfMeasureGroupingContent)
        {
        ...
        public Company_UnitOfMeasureDTO(UnitOfMeasure UnitOfMeasure)
        {
    ...
    public class Company_UnitOfMeasureFilterDTO : FilterDTO
    {
