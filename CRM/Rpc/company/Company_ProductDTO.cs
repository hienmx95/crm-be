...
{
    public class Company_ProductDTO : DataDTO
    {
        ...
        public Company_TaxTypeDTO TaxType { get; set; }
        public Company_ProductTypeDTO ProductType { get; set; }
        public Company_SupplierDTO Supplier { get; set; }
        public Company_UnitOfMeasureDTO UnitOfMeasure { get; set; }
        public List<Company_ProductProductGroupingMappingDTO> ProductProductGroupingMappings { get; set; }
        public DateTime CreatedAt { get; set; }
        public DateTime UpdatedAt { get; set; }
        public Company_ProductDTO() { }
        public Company_ProductDTO(Product Product)
        {
            this.Id = Product.Id;
            ...
            this.TaxType = Product.TaxType == null ? null : new Company_TaxTypeDTO(Product.TaxType);
            this.ProductType = Product.ProductType == null ? null : new Company_ProductTypeDTO(Product.ProductType);
            this.Supplier = Product.Supplier == null ? null : new Company_SupplierDTO(Product.Supplier);
            this.UnitOfMeasure = Product.UnitOfMeasure == null ? null : new Company_UnitOfMeasureDTO(Product.UnitOfMeasure);
            this.ProductProductGroupingMappings = Product.ProductProductGroupingMappings?.Select(x => new Company_ProductProductGroupingMappingDTO(x)).ToList();
    ...
    public class Company_ProductFilterDTO : FilterDTO
    {
