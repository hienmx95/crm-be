...
{
    public class Company_OpportunityResultTypeDTO : DataDTO
    {
        ...
        public Company_OpportunityResultTypeDTO() {}
        public Company_OpportunityResultTypeDTO(OpportunityResultType OpportunityResultType)
        {
    ...
    public class Company_OpportunityResultTypeFilterDTO : FilterDTO
    {
