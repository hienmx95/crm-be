...
{
    public class Company_SupplierDTO : DataDTO
    {
        ...
        public Company_SupplierDTO() {}
        public Company_SupplierDTO(Supplier Supplier)
        {
    ...
    public class Company_SupplierFilterDTO : FilterDTO
    {
