...
{
    public class Company_CallTypeDTO : DataDTO
    {
        ...
        public Company_CallTypeDTO() {}
        public Company_CallTypeDTO(CallType CallType)
        {
    ...
    public class Company_CallTypeFilterDTO : FilterDTO
    {
