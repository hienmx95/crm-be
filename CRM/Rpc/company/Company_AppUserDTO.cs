...
{
    public class Company_AppUserDTO : DataDTO
    {
        ...
        public Company_AppUserDTO() {}
        public Company_AppUserDTO(AppUser AppUser)
        {
    ...
    public class Company_AppUserFilterDTO : FilterDTO
    {
