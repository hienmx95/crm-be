...
{
    public class Company_SmsTemplateDTO : DataDTO
    {
        ...
        public Company_SmsTemplateDTO() {}
        public Company_SmsTemplateDTO(SmsTemplate SmsTemplate)
        {
    ...
    public class Company_SmsTemplateFilterDTO : FilterDTO
    {
