...
{
    public class Company_CustomerDTO : DataDTO
    {
        ...
        public Company_CustomerDTO() {}
        public Company_CustomerDTO(Customer Customer)
        {
            ...
            this.Company = Customer.Company == null ? null : new Company_CompanyDTO(Customer.Company);
            
            this.Errors = Customer.Errors;
        }
    }

    public class Company_CustomerFilterDTO : FilterDTO
    {
