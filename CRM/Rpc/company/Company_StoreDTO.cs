...
{
    public class Company_StoreDTO : DataDTO
    {
        ...
        public Company_StoreDTO ParentStore { get; set; }
        public Company_StoreDTO() { }
        public Company_StoreDTO(Store Store)
        {
            ...
            this.ParentStore = Store.ParentStore == null ? null : new Company_StoreDTO(Store.ParentStore);
            this.Errors = Store.Errors;
        }
    }

    public class Company_StoreFilterDTO : FilterDTO
    {
