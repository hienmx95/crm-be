...
{
    public class Company_UnitOfMeasureGroupingDTO : DataDTO
    {
        ...
        public Company_UnitOfMeasureGroupingDTO() {}
        public Company_UnitOfMeasureGroupingDTO(UnitOfMeasureGrouping UnitOfMeasureGrouping)
        {
    ...
    public class Company_UnitOfMeasureGroupingFilterDTO : FilterDTO
    {
