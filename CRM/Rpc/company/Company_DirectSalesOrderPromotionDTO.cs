...
{
    public class Company_DirectSalesOrderPromotionDTO : DataDTO
    {
        ...
        public Company_DirectSalesOrderPromotionDTO() { }
    ...
    public class Company_DirectSalesOrderPromotionFilterDTO : FilterDTO
    {
