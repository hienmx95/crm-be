...
{
    public class Company_DirectSalesOrderContentDTO : DataDTO
    {
        ...
        public Company_DirectSalesOrderContentDTO() { }
        public Company_DirectSalesOrderContentDTO(DirectSalesOrderContent DirectSalesOrderContent)
        {
            ...
            this.EditedPriceStatus = DirectSalesOrderContent.EditedPriceStatus == null ? null : new Company_EditedPriceStatusDTO(DirectSalesOrderContent.EditedPriceStatus);
            this.Item = DirectSalesOrderContent.Item == null ? null : new Company_ItemDTO(DirectSalesOrderContent.Item);
            this.PrimaryUnitOfMeasure = DirectSalesOrderContent.PrimaryUnitOfMeasure == null ? null : new Company_UnitOfMeasureDTO(DirectSalesOrderContent.PrimaryUnitOfMeasure);
            this.UnitOfMeasure = DirectSalesOrderContent.UnitOfMeasure == null ? null : new Company_UnitOfMeasureDTO(DirectSalesOrderContent.UnitOfMeasure);
            this.Errors = DirectSalesOrderContent.Errors;
        }
    }

    public class Company_DirectSalesOrderContentFilterDTO : FilterDTO
    {
