...
{
    public class Company_TaxTypeDTO : DataDTO
    {
        ...
        public Company_TaxTypeDTO() {}
        public Company_TaxTypeDTO(TaxType TaxType)
        {
    ...
    public class Company_TaxTypeFilterDTO : FilterDTO
    {
