...
{
    public class Company_MailTemplateDTO : DataDTO
    {
        ...
        public Company_MailTemplateDTO() {}
        public Company_MailTemplateDTO(MailTemplate MailTemplate)
        {
    ...
    public class Company_MailTemplateFilterDTO : FilterDTO
    {
