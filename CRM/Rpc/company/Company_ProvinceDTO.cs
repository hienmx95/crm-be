...
{
    public class Company_ProvinceDTO : DataDTO
    {
        ...
        public Company_ProvinceDTO() {}
        public Company_ProvinceDTO(Province Province)
        {
    ...
    public class Company_ProvinceFilterDTO : FilterDTO
    {
