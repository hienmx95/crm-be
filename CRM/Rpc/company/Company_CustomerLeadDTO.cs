...
{
    public class Company_CustomerLeadDTO : DataDTO
    {
        ...
        public Company_CustomerLeadDTO() {}
        public Company_CustomerLeadDTO(CustomerLead CustomerLead)
        {
    ...
    public class Company_CustomerLeadFilterDTO : FilterDTO
    {
