...
{
    public class Company_CustomerSalesOrderContentDTO : DataDTO
    {
        ...
        public Company_CustomerSalesOrderContentDTO() {}
        public Company_CustomerSalesOrderContentDTO(CustomerSalesOrderContent CustomerSalesOrderContent)
        {
            ...
            this.EditedPriceStatus = CustomerSalesOrderContent.EditedPriceStatus == null ? null : new Company_EditedPriceStatusDTO(CustomerSalesOrderContent.EditedPriceStatus);
            this.Item = CustomerSalesOrderContent.Item == null ? null : new Company_ItemDTO(CustomerSalesOrderContent.Item);
            this.PrimaryUnitOfMeasure = CustomerSalesOrderContent.PrimaryUnitOfMeasure == null ? null : new Company_UnitOfMeasureDTO(CustomerSalesOrderContent.PrimaryUnitOfMeasure);
            this.UnitOfMeasure = CustomerSalesOrderContent.UnitOfMeasure == null ? null : new Company_UnitOfMeasureDTO(CustomerSalesOrderContent.UnitOfMeasure);
            this.Errors = CustomerSalesOrderContent.Errors;
        }
    }

    public class Company_CustomerSalesOrderContentFilterDTO : FilterDTO
    {
