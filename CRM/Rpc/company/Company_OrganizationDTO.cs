...
{
    public class Company_OrganizationDTO : DataDTO
    {
        ...
        public Company_OrganizationDTO() {}
        public Company_OrganizationDTO(Organization Organization)
        {
    ...
    public class Company_OrganizationFilterDTO : FilterDTO
    {
