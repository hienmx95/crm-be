...
{
    public class CallLog_CallTypeDTO : DataDTO
    {
        ...
        public CallLog_CallTypeDTO() {}
        public CallLog_CallTypeDTO(CallType CallType)
        {
    ...
    public class CallLog_CallTypeFilterDTO : FilterDTO
    {
