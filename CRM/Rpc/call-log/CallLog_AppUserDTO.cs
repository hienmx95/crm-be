...
{
    public class CallLog_AppUserDTO : DataDTO
    {
        ...
        public CallLog_AppUserDTO() {}
        public CallLog_AppUserDTO(AppUser AppUser)
        {
    ...
    public class CallLog_AppUserFilterDTO : FilterDTO
    {
