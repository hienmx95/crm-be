...
{
    public class Ticket_OrganizationDTO : DataDTO
    {
        ...
        public Ticket_OrganizationDTO() {}
        public Ticket_OrganizationDTO(Organization Organization)
        {
    ...
    public class Ticket_OrganizationFilterDTO : FilterDTO
    {
