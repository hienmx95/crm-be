...
{
    public class Ticket_CustomerDTO : DataDTO
    {
        ...
        public Ticket_CustomerDTO() {}
        public Ticket_CustomerDTO(Customer Customer)
        {
    ...
    public class Ticket_CustomerFilterDTO : FilterDTO
    {
