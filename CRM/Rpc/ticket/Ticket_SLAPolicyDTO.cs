...
{
    public class Ticket_SLAPolicyDTO : DataDTO
    {
        ...
        public Ticket_SLAPolicyDTO() {}
        public Ticket_SLAPolicyDTO(SLAPolicy SLAPolicy)
        {
    ...
    public class Ticket_SLAPolicyFilterDTO : FilterDTO
    {
