...
{
    public class ScheduleMaster_AppUserDTO : DataDTO
    {
        ...
        public ScheduleMaster_AppUserDTO() {}
        public ScheduleMaster_AppUserDTO(AppUser AppUser)
        {
    ...
    public class ScheduleMaster_AppUserFilterDTO : FilterDTO
    {
