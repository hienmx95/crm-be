...
{
    public class TicketIssueLevel_TicketTypeDTO : DataDTO
    {
        ...
        public TicketIssueLevel_TicketTypeDTO() {}
        public TicketIssueLevel_TicketTypeDTO(TicketType TicketType)
        {
    ...
    public class TicketIssueLevel_TicketTypeFilterDTO : FilterDTO
    {
