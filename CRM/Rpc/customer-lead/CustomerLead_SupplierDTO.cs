...
{
    public class CustomerLead_SupplierDTO : DataDTO
    {
        ...
        public CustomerLead_SupplierDTO() {}
        public CustomerLead_SupplierDTO(Supplier Supplier)
        {
    ...
    public class CustomerLead_SupplierFilterDTO : FilterDTO
    {
