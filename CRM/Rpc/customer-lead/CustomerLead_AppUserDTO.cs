...
{
    public class CustomerLead_AppUserDTO : DataDTO
    {
        ...
        public CustomerLead_AppUserDTO() {}
        public CustomerLead_AppUserDTO(AppUser AppUser)
        {
    ...
    public class CustomerLead_AppUserFilterDTO : FilterDTO
    {
