...
{
    public class CustomerLead_ProductGroupingDTO : DataDTO
    {
        ...
        public CustomerLead_ProductGroupingDTO() { }
    ...
    public class CustomerLead_ProductGroupingFilterDTO : FilterDTO
    {
