...
{
    public class CustomerLead_ProductTypeDTO : DataDTO
    {
        ...
        public CustomerLead_ProductTypeDTO() {}
        public CustomerLead_ProductTypeDTO(ProductType ProductType)
        {
    ...
    public class CustomerLead_ProductTypeFilterDTO : FilterDTO
    {
