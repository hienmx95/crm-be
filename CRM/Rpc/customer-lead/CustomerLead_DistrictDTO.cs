...
{
    public class CustomerLead_DistrictDTO : DataDTO
    {
        ...
        public CustomerLead_DistrictDTO() {}
        public CustomerLead_DistrictDTO(District District)
        {
    ...
    public class CustomerLead_DistrictFilterDTO : FilterDTO
    {
