...
{
    public class CustomerLead_CallTypeDTO : DataDTO
    {
        ...
        public CustomerLead_CallTypeDTO() {}
        public CustomerLead_CallTypeDTO(CallType CallType)
        {
    ...
    public class CustomerLead_CallTypeFilterDTO : FilterDTO
    {
