...
{
    public class CustomerLead_CompanyDTO : DataDTO
    {
        ...
        public CustomerLead_CompanyDTO() {}
        public CustomerLead_CompanyDTO(Company Company)
        {
            this.Id = Company.Id;
    ...
    public class CustomerLead_CompanyFilterDTO : FilterDTO
    {
