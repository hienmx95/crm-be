...
{
    public class CustomerLead_MailTemplateDTO : DataDTO
    {
        ...
        public CustomerLead_MailTemplateDTO() {}
        public CustomerLead_MailTemplateDTO(MailTemplate MailTemplate)
        {
    ...
    public class CustomerLead_MailTemplateFilterDTO : FilterDTO
    {
