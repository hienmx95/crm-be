...
{
    public class CustomerLead_SmsQueueDTO : DataDTO
    {
        ...
        public CustomerLead_AppUserDTO SentByAppUser { get; set; }
        public CustomerLead_SmsQueueStatusDTO SmsQueueStatus { get; set; }
        ...
        public CustomerLead_SmsQueueDTO() { }
