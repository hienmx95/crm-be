...
{
    public class CustomerFeedback_CustomerDTO : DataDTO
    {
        ...
        public CustomerFeedback_CustomerDTO() {}
        public CustomerFeedback_CustomerDTO(Customer Customer)
        {
    ...
    public class CustomerFeedback_CustomerFilterDTO : FilterDTO
    {
