...
{
    public class OrderQuote_OpportunityDTO : DataDTO
    {
        ...
        public OrderQuote_OpportunityDTO() {}
        public OrderQuote_OpportunityDTO(Opportunity Opportunity)
        {
    ...
    public class OrderQuote_OpportunityFilterDTO : FilterDTO
    {
