...
{
    public class OrderQuote_TaxTypeDTO : DataDTO
    {
        ...
        public OrderQuote_TaxTypeDTO() {}
        public OrderQuote_TaxTypeDTO(TaxType TaxType)
        {
    ...
    public class OrderQuote_TaxTypeFilterDTO : FilterDTO
    {
