...
{
    public class OrderQuote_AppUserDTO : DataDTO
    {
        ...
        public OrderQuote_AppUserDTO() {}
        public OrderQuote_AppUserDTO(AppUser AppUser)
        {
    ...
    public class OrderQuote_AppUserFilterDTO : FilterDTO
    {
