...
{
    public class OrderQuote_UnitOfMeasureGroupingDTO : DataDTO
    {
        ...
        public OrderQuote_UnitOfMeasureGroupingDTO() {}
        public OrderQuote_UnitOfMeasureGroupingDTO(UnitOfMeasureGrouping UnitOfMeasureGrouping)
        {
    ...
    public class OrderQuote_UnitOfMeasureGroupingFilterDTO : FilterDTO
    {
