...
{
    public class OrderQuote_CompanyDTO : DataDTO
    {
        ...
        public OrderQuote_CompanyDTO() {}
        public OrderQuote_CompanyDTO(Company Company)
        {
    ...
    public class OrderQuote_CompanyFilterDTO : FilterDTO
    {
