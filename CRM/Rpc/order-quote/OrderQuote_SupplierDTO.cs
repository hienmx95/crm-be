...
{
    public class OrderQuote_SupplierDTO : DataDTO
    {
        ...
        public OrderQuote_SupplierDTO() {}
        public OrderQuote_SupplierDTO(Supplier Supplier)
        {
    ...
    public class OrderQuote_SupplierFilterDTO : FilterDTO
    {
