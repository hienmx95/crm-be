...
namespace CRM.Rpc.organization
{
    public class OrganizationRoute : Root
    {
        ...
        {
            { "Tìm kiếm", new List<string> { Master, Count, List, Get, FilterListOrganization, FilterListStatus, FilterListAppUser, Parent } },
            { "Xuất excel", new List<string> { Master, Count, List, Get, FilterListOrganization, FilterListStatus, FilterListAppUser, Export, ExportAppUser } },
        };
    }
}
