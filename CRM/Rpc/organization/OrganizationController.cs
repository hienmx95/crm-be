...
namespace CRM.Rpc.organization
{
    public class OrganizationController : RpcController
    {
       ...
       ,IHttpContextAccessor httpContextAccessor, DataContext _DataContext
        ...
        public async Task<ActionResult<List<Organization_StatusDTO>>> FilterListStatus([FromBody] Organization_StatusFilterDTO Organization_StatusFilterDTO)
        {
            if (UnAuthorization) return Forbid();
        ...
        public async Task<ActionResult<List<Organization_StatusDTO>>> SingleListStatus([FromBody] Organization_StatusFilterDTO Organization_StatusFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            StatusFilter StatusFilter = new StatusFilter();
            StatusFilter.Skip = 0;
