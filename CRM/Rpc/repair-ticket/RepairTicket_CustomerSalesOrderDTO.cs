...
{
    public class RepairTicket_CustomerSalesOrderDTO : DataDTO
    {
        ...
        public RepairTicket_CustomerSalesOrderDTO() {}
    ...
    public class RepairTicket_CustomerSalesOrderFilterDTO : FilterDTO
    {
