...
{
    public class RepairTicket_DirectSalesOrderDTO : DataDTO
    {
        ...
        public RepairTicket_DirectSalesOrderDTO() { }
        public RepairTicket_DirectSalesOrderDTO(DirectSalesOrder DirectSalesOrder)
        {
    ...
    public class RepairTicket_DirectSalesOrderFilterDTO : FilterDTO
    {
