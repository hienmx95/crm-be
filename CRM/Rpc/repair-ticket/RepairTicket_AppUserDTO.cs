...
{
    public class RepairTicket_AppUserDTO : DataDTO
    {
        ...
        public RepairTicket_AppUserDTO() {}
        public RepairTicket_AppUserDTO(AppUser AppUser)
        {
    ...
    public class RepairTicket_AppUserFilterDTO : FilterDTO
    {
