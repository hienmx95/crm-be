...
{
    public class Opportunity_MailTemplateDTO : DataDTO
    {
        ...
        public Opportunity_MailTemplateDTO() {}
        public Opportunity_MailTemplateDTO(MailTemplate MailTemplate)
        {
    ...
    public class Opportunity_MailTemplateFilterDTO : FilterDTO
    {
