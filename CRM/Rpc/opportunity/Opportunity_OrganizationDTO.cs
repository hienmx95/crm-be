...
{
    public class Opportunity_OrganizationDTO : DataDTO
    {
        ...
        public Opportunity_OrganizationDTO() {}
        public Opportunity_OrganizationDTO(Organization Organization)
        {
    ...
    public class Contact_OrganizationFilterDTO : FilterDTO
    {
