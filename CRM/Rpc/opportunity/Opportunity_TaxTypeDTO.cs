...
{
    public class Opportunity_TaxTypeDTO : DataDTO
    {
        ...
        public Opportunity_TaxTypeDTO() {}
        public Opportunity_TaxTypeDTO(TaxType TaxType)
        {
    ...
    public class Opportunity_TaxTypeFilterDTO : FilterDTO
    {
