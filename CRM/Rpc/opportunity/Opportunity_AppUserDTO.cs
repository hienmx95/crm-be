...
{
    public class Opportunity_AppUserDTO : DataDTO
    {
        ...
        public Opportunity_AppUserDTO() {}
        public Opportunity_AppUserDTO(AppUser AppUser)
        {
    ...
    public class Opportunity_AppUserFilterDTO : FilterDTO
    {
