...
{
    public class Opportunity_OpportunityResultTypeDTO : DataDTO
    {
        ...
        public Opportunity_OpportunityResultTypeDTO() {}
        public Opportunity_OpportunityResultTypeDTO(OpportunityResultType OpportunityResultType)
        {
    ...
    public class Opportunity_OpportunityResultTypeFilterDTO : FilterDTO
    {
