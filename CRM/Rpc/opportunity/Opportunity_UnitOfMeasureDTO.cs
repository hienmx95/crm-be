...
{
    public class Opportunity_UnitOfMeasureDTO : DataDTO
    {
        ...
        public Opportunity_UnitOfMeasureDTO() {}
        public Opportunity_UnitOfMeasureDTO(UnitOfMeasureGroupingContent UnitOfMeasureGroupingContent)
        {
        ...
        public Opportunity_UnitOfMeasureDTO(UnitOfMeasure UnitOfMeasure)
        {
    ...
    public class Opportunity_UnitOfMeasureFilterDTO : FilterDTO
    {
