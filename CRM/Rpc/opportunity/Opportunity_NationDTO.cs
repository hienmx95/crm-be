...
{
    public class Opportunity_NationDTO : DataDTO
    {
        ...
        public Opportunity_NationDTO() {}
        public Opportunity_NationDTO(Nation Nation)
        {
    ...
    public class Opportunity_NationFilterDTO : FilterDTO
    {
