...
{
    public class Opportunity_SupplierDTO : DataDTO
    {
        ...
        public Opportunity_SupplierDTO() {}
        public Opportunity_SupplierDTO(Supplier Supplier)
        {
    ...
    public class Opportunity_SupplierFilterDTO : FilterDTO
    {
