...
{
    public class Opportunity_ProductDTO : DataDTO
    {
        ...
        public Opportunity_TaxTypeDTO TaxType { get; set; }
        public Opportunity_ProductTypeDTO ProductType { get; set; }
        public Opportunity_SupplierDTO Supplier { get; set; }
        public Opportunity_UnitOfMeasureDTO UnitOfMeasure { get; set; }
        public List<Opportunity_ProductProductGroupingMappingDTO> ProductProductGroupingMappings { get; set; }
        public DateTime CreatedAt { get; set; }
        public DateTime UpdatedAt { get; set; }
        public Opportunity_ProductDTO() { }
        public Opportunity_ProductDTO(Product Product)
        {
            this.Id = Product.Id;
            ...
            this.TaxType = Product.TaxType == null ? null : new Opportunity_TaxTypeDTO(Product.TaxType);
            this.ProductType = Product.ProductType == null ? null : new Opportunity_ProductTypeDTO(Product.ProductType);
            this.Supplier = Product.Supplier == null ? null : new Opportunity_SupplierDTO(Product.Supplier);
            this.UnitOfMeasure = Product.UnitOfMeasure == null ? null : new Opportunity_UnitOfMeasureDTO(Product.UnitOfMeasure);
            this.ProductProductGroupingMappings = Product.ProductProductGroupingMappings?.Select(x => new Opportunity_ProductProductGroupingMappingDTO(x)).ToList();
    ...
    public class Opportunity_ProductFilterDTO : FilterDTO
    {
