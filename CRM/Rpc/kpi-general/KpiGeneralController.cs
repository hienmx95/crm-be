...
using CRM.Enums;
using CRM.Services.MKpiGeneralContent;
using System.Text;
using CRM.Models;
    ...
    public class KpiGeneralController : RpcController
    {
       ...
       ,IHttpContextAccessor httpContextAccessor, DataContext _DataContext
        ...
        public async Task<ActionResult<KpiGeneral_KpiGeneralDTO>> GetDraft([FromBody] KpiGeneral_KpiGeneralDTO kpiGeneral_KpiGeneralDTO)
        {
            ...
            }).OrderBy(p => p.KpiCriteriaGeneralId).ToList();
        ...
        //        #region Số lead
        //        var TotalLeadsContent = KpiGeneral_KpiGeneralContentDTOs
        //            .Where(x => x.KpiCriteriaGeneralId == KpiCriteriaGeneralEnum.TOTAL_LEAD.Id)
        ...
        public async Task<ActionResult<List<KpiGeneral_AppUserDTO>>> FilterListAppUser([FromBody] KpiGeneral_AppUserFilterDTO KpiGeneral_AppUserFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiGeneral_AppUserDTO>>> FilterListCreator([FromBody] KpiGeneral_AppUserFilterDTO KpiGeneral_AppUserFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiGeneral_KpiYearDTO>>> FilterListKpiYear([FromBody] KpiGeneral_KpiYearFilterDTO KpiGeneral_KpiYearFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiGeneral_OrganizationDTO>>> FilterListOrganization([FromBody] KpiGeneral_OrganizationFilterDTO KpiGeneral_OrganizationFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiGeneral_StatusDTO>>> FilterListStatus([FromBody] KpiGeneral_StatusFilterDTO KpiGeneral_StatusFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiGeneral_KpiCriteriaGeneralDTO>>> FilterListKpiCriteriaGeneral([FromBody] KpiGeneral_KpiCriteriaGeneralFilterDTO KpiGeneral_KpiCriteriaGeneralFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiGeneral_AppUserDTO>>> SingleListAppUser([FromBody] KpiGeneral_AppUserFilterDTO KpiGeneral_AppUserFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiGeneral_KpiYearDTO>>> SingleListKpiYear([FromBody] KpiGeneral_KpiYearFilterDTO KpiGeneral_KpiYearFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiGeneral_OrganizationDTO>>> SingleListOrganization([FromBody] KpiGeneral_OrganizationFilterDTO KpiGeneral_OrganizationFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiGeneral_StatusDTO>>> SingleListStatus([FromBody] KpiGeneral_StatusFilterDTO KpiGeneral_StatusFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiGeneral_KpiCriteriaGeneralDTO>>> SingleListKpiCriteriaGeneral([FromBody] KpiGeneral_KpiCriteriaGeneralFilterDTO KpiGeneral_KpiCriteriaGeneralFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<long>> CountAppUser([FromBody] KpiGeneral_AppUserFilterDTO KpiGeneral_AppUserFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            AppUserFilter AppUserFilter = new AppUserFilter();
            AppUserFilter.Id = KpiGeneral_AppUserFilterDTO.Id;
        ...
        public async Task<ActionResult<List<KpiGeneral_AppUserDTO>>> ListAppUser([FromBody] KpiGeneral_AppUserFilterDTO KpiGeneral_AppUserFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            AppUserFilter AppUserFilter = new AppUserFilter();
