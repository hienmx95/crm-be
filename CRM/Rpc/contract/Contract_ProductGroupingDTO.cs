...
{
    public class Contract_ProductGroupingDTO : DataDTO
    {
        ...
        public Contract_ProductGroupingDTO() { }
        public Contract_ProductGroupingDTO(ProductGrouping ProductGrouping)
        {
    ...
    public class Contract_ProductGroupingFilterDTO : FilterDTO
    {
