...
{
    public class Contract_SupplierDTO : DataDTO
    {
        ...
        public Contract_SupplierDTO() {}
        public Contract_SupplierDTO(Supplier Supplier)
        {
    ...
    public class Contract_SupplierFilterDTO : FilterDTO
    {
