...
{
    public class Contract_CompanyDTO : DataDTO
    {
        ...
        public Contract_CompanyDTO() {}
        public Contract_CompanyDTO(Company Company)
        {
            this.Id = Company.Id;
    ...
    public class Contract_CompanyFilterDTO : FilterDTO
    {
