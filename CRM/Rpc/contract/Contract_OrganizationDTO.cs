...
{
    public class Contract_OrganizationDTO : DataDTO
    {
        ...
        public Contract_OrganizationDTO() {}
        public Contract_OrganizationDTO(Organization Organization)
        {
    ...
    public class Contract_OrganizationFilterDTO : FilterDTO
    {
