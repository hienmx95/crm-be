...
{
    public class Contract_CustomerDTO : DataDTO
    {
        ...
        public Contract_CustomerDTO() { }
        public Contract_CustomerDTO(Customer Customer)
        {
            ...
            this.Company = Customer.Company == null ? null : new Contract_CompanyDTO(Customer.Company);

            this.Errors = Customer.Errors;
        }
    }

    public class Contract_CustomerFilterDTO : FilterDTO
    {
