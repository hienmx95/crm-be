...
{
    public class Contract_ContractDTO : DataDTO
    {
        ...
        public Contract_ContractStatusDTO ContractStatus { get; set; }
        public Contract_ContractTypeDTO ContractType { get; set; }
        public Contract_AppUserDTO Creator { get; set; }
        public Contract_CurrencyDTO Currency { get; set; }
        public Contract_CustomerDTO Customer { get; set; }
        public Contract_DistrictDTO InvoiceDistrict { get; set; }
        public Contract_NationDTO InvoiceNation { get; set; }
        public Contract_ProvinceDTO InvoiceProvince { get; set; }
        public Contract_OpportunityDTO Opportunity { get; set; }
        public Contract_OrganizationDTO Organization { get; set; }
        public Contract_PaymentStatusDTO PaymentStatus { get; set; }
        public Contract_DistrictDTO ReceiveDistrict { get; set; }
        public Contract_NationDTO ReceiveNation { get; set; }
        public Contract_ProvinceDTO ReceiveProvince { get; set; }
        public List<Contract_ContractContactMappingDTO> ContractContactMappings { get; set; }
        public List<Contract_ContractFileGroupingDTO> ContractFileGroupings { get; set; }
        public List<Contract_ContractItemDetailDTO> ContractItemDetails { get; set; }
        public List<Contract_ContractPaymentHistoryDTO> ContractPaymentHistories { get; set; }
        public DateTime CreatedAt { get; set; }
        public DateTime UpdatedAt { get; set; }
        public Contract_ContractDTO() {}
        public Contract_ContractDTO(Contract Contract)
        {
            this.Id = Contract.Id;
            ...
            this.AppUser = Contract.AppUser == null ? null : new Contract_AppUserDTO(Contract.AppUser);
            this.Company = Contract.Company == null ? null : new Contract_CompanyDTO(Contract.Company);
            this.ContractStatus = Contract.ContractStatus == null ? null : new Contract_ContractStatusDTO(Contract.ContractStatus);
            this.ContractType = Contract.ContractType == null ? null : new Contract_ContractTypeDTO(Contract.ContractType);
            this.Creator = Contract.Creator == null ? null : new Contract_AppUserDTO(Contract.Creator);
            this.Currency = Contract.Currency == null ? null : new Contract_CurrencyDTO(Contract.Currency);
            this.Customer = Contract.Customer == null ? null : new Contract_CustomerDTO(Contract.Customer);
            this.InvoiceDistrict = Contract.InvoiceDistrict == null ? null : new Contract_DistrictDTO(Contract.InvoiceDistrict);
            this.InvoiceNation = Contract.InvoiceNation == null ? null : new Contract_NationDTO(Contract.InvoiceNation);
            this.InvoiceProvince = Contract.InvoiceProvince == null ? null : new Contract_ProvinceDTO(Contract.InvoiceProvince);
            this.Opportunity = Contract.Opportunity == null ? null : new Contract_OpportunityDTO(Contract.Opportunity);
            this.Organization = Contract.Organization == null ? null : new Contract_OrganizationDTO(Contract.Organization);
            this.PaymentStatus = Contract.PaymentStatus == null ? null : new Contract_PaymentStatusDTO(Contract.PaymentStatus);
            this.ReceiveDistrict = Contract.ReceiveDistrict == null ? null : new Contract_DistrictDTO(Contract.ReceiveDistrict);
            this.ReceiveNation = Contract.ReceiveNation == null ? null : new Contract_NationDTO(Contract.ReceiveNation);
            this.ReceiveProvince = Contract.ReceiveProvince == null ? null : new Contract_ProvinceDTO(Contract.ReceiveProvince);
            this.ContractContactMappings = Contract.ContractContactMappings?.Select(x => new Contract_ContractContactMappingDTO(x)).ToList();
            this.ContractFileGroupings = Contract.ContractFileGroupings?.Select(x => new Contract_ContractFileGroupingDTO(x)).ToList();
            this.ContractItemDetails = Contract.ContractItemDetails?.Select(x => new Contract_ContractItemDetailDTO(x)).ToList();
            this.ContractPaymentHistories = Contract.ContractPaymentHistories?.Select(x => new Contract_ContractPaymentHistoryDTO(x)).ToList();
    ...
    public class Contract_ContractFilterDTO : FilterDTO
    {
