...
{
    public class Contract_AppUserDTO : DataDTO
    {
        ...
        public Contract_AppUserDTO() {}
        public Contract_AppUserDTO(AppUser AppUser)
        {
    ...
    public class Contract_AppUserFilterDTO : FilterDTO
    {
