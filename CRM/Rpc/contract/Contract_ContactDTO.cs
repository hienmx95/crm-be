...
{
    public class Contract_ContactDTO : DataDTO
    {
        ...
        public Contract_ContactDTO() {}
        public Contract_ContactDTO(Contact Contact)
        {
    ...
    public class Contract_ContactFilterDTO : FilterDTO
    {
