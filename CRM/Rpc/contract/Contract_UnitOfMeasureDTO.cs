...
{
    public class Contract_UnitOfMeasureDTO : DataDTO
    {
        ...
        public Contract_UnitOfMeasureDTO() {}
        public Contract_UnitOfMeasureDTO(UnitOfMeasureGroupingContent UnitOfMeasureGroupingContent)
        {
        ...
        public Contract_UnitOfMeasureDTO(UnitOfMeasure UnitOfMeasure)
        {
    ...
    public class Contract_UnitOfMeasureFilterDTO : FilterDTO
    {
