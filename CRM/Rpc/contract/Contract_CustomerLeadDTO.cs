...
{
    public class Contract_CustomerLeadDTO : DataDTO
    {
        ...
        public Contract_CustomerLeadDTO() {}
        public Contract_CustomerLeadDTO(CustomerLead CustomerLead)
        {
    ...
    public class Contract_CustomerLeadFilterDTO : FilterDTO
    {
