...
{
    public class Contract_TaxTypeDTO : DataDTO
    {
        ...
        public Contract_TaxTypeDTO() {}
        public Contract_TaxTypeDTO(TaxType TaxType)
        {
    ...
    public class Contract_TaxTypeFilterDTO : FilterDTO
    {
