...
{
    public class Contract_CustomerLevelDTO : DataDTO
    {
        ...
        public Contract_CustomerLevelDTO() {}
        public Contract_CustomerLevelDTO(CustomerLevel CustomerLevel)
        {
    ...
    public class Contract_CustomerLevelFilterDTO : FilterDTO
    {
