...
{
    public class Contract_ProductTypeDTO : DataDTO
    {
        ...
        public Contract_ProductTypeDTO() {}
        public Contract_ProductTypeDTO(ProductType ProductType)
        {
    ...
    public class Contract_ProductTypeFilterDTO : FilterDTO
    {
