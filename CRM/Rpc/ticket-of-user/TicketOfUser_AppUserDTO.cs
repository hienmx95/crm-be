...
{
    public class TicketOfUser_AppUserDTO : DataDTO
    {
        ...
        public TicketOfUser_AppUserDTO() {}
        public TicketOfUser_AppUserDTO(AppUser AppUser)
        {
    ...
    public class TicketOfUser_AppUserFilterDTO : FilterDTO
    {
