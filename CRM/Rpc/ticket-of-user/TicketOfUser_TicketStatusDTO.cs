...
{
    public class TicketOfUser_TicketStatusDTO : DataDTO
    {
        ...
        public TicketOfUser_TicketStatusDTO() {}
        public TicketOfUser_TicketStatusDTO(TicketStatus TicketStatus)
        {
    ...
    public class TicketOfUser_TicketStatusFilterDTO : FilterDTO
    {
