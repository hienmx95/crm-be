...
{
    public class WorkflowDirection_AppUserDTO : DataDTO
    {
        ...
        public WorkflowDirection_AppUserDTO() { }
        public WorkflowDirection_AppUserDTO(AppUser AppUser)
        {
    ...
    public class WorkflowDirection_AppUserFilterDTO : FilterDTO
    {
