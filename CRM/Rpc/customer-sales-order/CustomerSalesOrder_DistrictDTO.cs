...
{
    public class CustomerSalesOrder_DistrictDTO : DataDTO
    {
        ...
        public CustomerSalesOrder_DistrictDTO() {}
        public CustomerSalesOrder_DistrictDTO(District District)
        {
    ...
    public class CustomerSalesOrder_DistrictFilterDTO : FilterDTO
    {
