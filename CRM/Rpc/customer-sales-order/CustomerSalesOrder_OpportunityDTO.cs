...
{
    public class CustomerSalesOrder_OpportunityDTO : DataDTO
    {
        ...
        public CustomerSalesOrder_OpportunityDTO() {}
        public CustomerSalesOrder_OpportunityDTO(Opportunity Opportunity)
        {
    ...
    public class CustomerSalesOrder_OpportunityFilterDTO : FilterDTO
    {
