...
{
    public class CustomerSalesOrder_ContractDTO : DataDTO
    {
        ...
        public CustomerSalesOrder_ContractDTO() {}
        public CustomerSalesOrder_ContractDTO(Contract Contract)
        {
    ...
    public class CustomerSalesOrder_ContractFilterDTO : FilterDTO
    {
