...
{
    public class CustomerSalesOrder_ProvinceDTO : DataDTO
    {
        ...
        public CustomerSalesOrder_ProvinceDTO() {}
        public CustomerSalesOrder_ProvinceDTO(Province Province)
        {
    ...
    public class CustomerSalesOrder_ProvinceFilterDTO : FilterDTO
    {
