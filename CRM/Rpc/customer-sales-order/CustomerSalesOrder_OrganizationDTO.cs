...
{
    public class CustomerSalesOrder_OrganizationDTO : DataDTO
    {
        ...
        public CustomerSalesOrder_OrganizationDTO() {}
        public CustomerSalesOrder_OrganizationDTO(Organization Organization)
        {
    ...
    public class CustomerSalesOrder_OrganizationFilterDTO : FilterDTO
    {
