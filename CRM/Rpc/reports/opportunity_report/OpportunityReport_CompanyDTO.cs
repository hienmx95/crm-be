...
{
    public class OpportunityReport_CompanyDTO : DataDTO
    {
        ...
        public OpportunityReport_CompanyDTO() {}
        public OpportunityReport_CompanyDTO(Company Company)
        {
            this.Id = Company.Id;
    ...
    public class OpportunityReport_CompanyFilterDTO : FilterDTO
    {
