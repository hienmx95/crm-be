...
{
    public class OpportunityReport_ContactDTO : DataDTO
    {
        ...
        public OpportunityReport_ContactDTO() { }
        public OpportunityReport_ContactDTO(Contact Contact)
        {
            this.Id = Contact.Id;
    ...
    public class OpportunityReport_ContactFilterDTO : FilterDTO
    {
