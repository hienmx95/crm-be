...
{
    public class OpportunityReport_AppUserDTO : DataDTO
    {
        ...
        public OpportunityReport_AppUserDTO() {}
        public OpportunityReport_AppUserDTO(AppUser AppUser)
        {
    ...
    public class OpportunityReport_AppUserFilterDTO : FilterDTO
    {
