...
{
    public class OrderReport_CompanyDTO : DataDTO
    {
        ...
        public OrderReport_CompanyDTO() {}
        public OrderReport_CompanyDTO(Company Company)
        {
            this.Id = Company.Id;
    ...
    public class OrderReport_CompanyFilterDTO : FilterDTO
    {
