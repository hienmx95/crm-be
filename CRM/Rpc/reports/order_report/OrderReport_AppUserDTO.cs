...
{
    public class OrderReport_AppUserDTO : DataDTO
    {
        ...
        public OrderReport_AppUserDTO() {}
        public OrderReport_AppUserDTO(AppUser AppUser)
        {
    ...
    public class OrderReport_AppUserFilterDTO : FilterDTO
    {
