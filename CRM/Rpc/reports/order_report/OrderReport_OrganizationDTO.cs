...
{
    public class OrderReport_OrganizationDTO : DataDTO
    {
        ...
        public OrderReport_OrganizationDTO() {}
        public OrderReport_OrganizationDTO(Organization Organization)
        {
    ...
    public class OrderReport_OrganizationFilterDTO : FilterDTO
    {
