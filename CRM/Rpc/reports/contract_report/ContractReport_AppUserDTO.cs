...
{
    public class ContractReport_AppUserDTO : DataDTO
    {
        ...
        public ContractReport_AppUserDTO() {}
        public ContractReport_AppUserDTO(AppUser AppUser)
        {
    ...
    public class ContractReport_AppUserFilterDTO : FilterDTO
    {
