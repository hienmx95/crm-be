...
{
    public class ContractReport_OpportunityDTO : DataDTO
    {
        ...
        public ContractReport_OpportunityDTO() {}
        public ContractReport_OpportunityDTO(Opportunity Opportunity)
        {
    ...
    public class ContractReport_OpportunityFilterDTO : FilterDTO
    {
