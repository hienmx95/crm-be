...
{
    public class ContractReport_OrganizationDTO : DataDTO
    {
        ...
        public ContractReport_OrganizationDTO() {}
        public ContractReport_OrganizationDTO(Organization Organization)
        {
    ...
    public class ContractReport_OrganizationFilterDTO : FilterDTO
    {
