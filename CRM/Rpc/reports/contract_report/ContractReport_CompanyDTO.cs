...
{
    public class ContractReport_CompanyDTO : DataDTO
    {
        ...
        public ContractReport_CompanyDTO() {}
        public ContractReport_CompanyDTO(Company Company)
        {
            this.Id = Company.Id;
    ...
    public class ContractReport_CompanyFilterDTO : FilterDTO
    {
