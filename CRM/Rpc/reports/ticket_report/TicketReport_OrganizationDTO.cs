...
{
    public class TicketReport_OrganizationDTO : DataDTO
    {
        ...
        public TicketReport_OrganizationDTO() {}
        public TicketReport_OrganizationDTO(Organization Organization)
        {
    ...
    public class TicketReport_OrganizationFilterDTO : FilterDTO
    {
