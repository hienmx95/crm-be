...
{
    public class TicketReport_AppUserDTO : DataDTO
    {
        ...
        public TicketReport_AppUserDTO() { }
        public TicketReport_AppUserDTO(AppUser AppUser)
        {
    ...
    public class TicketReport_AppUserFilterDTO : FilterDTO
    {
