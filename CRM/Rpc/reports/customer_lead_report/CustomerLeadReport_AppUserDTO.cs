...
{
    public class CustomerLeadReport_AppUserDTO : DataDTO
    {
        ...
        public CustomerLeadReport_AppUserDTO() {}
        public CustomerLeadReport_AppUserDTO(AppUser AppUser)
        {
    ...
    public class CustomerLeadReport_AppUserFilterDTO : FilterDTO
    {
