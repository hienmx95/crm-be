...
{
    public class CustomerLeadReport_CompanyDTO : DataDTO
    {
        ...
        public CustomerLeadReport_CompanyDTO() { }
        public CustomerLeadReport_CompanyDTO(Company Company)
        {
            this.Id = Company.Id;
    ...
    public class CustomerLeadReport_CompanyFilterDTO : FilterDTO
    {
