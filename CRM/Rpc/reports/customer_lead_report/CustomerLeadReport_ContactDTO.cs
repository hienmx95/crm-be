...
{
    public class CustomerLeadReport_ContactDTO : DataDTO
    {
        ...
        public CustomerLeadReport_ContactDTO() { }
        public CustomerLeadReport_ContactDTO(Contact Contact)
        {
            this.Id = Contact.Id;
    ...
    public class CustomerLeadReport_ContactFilterDTO : FilterDTO
    {
