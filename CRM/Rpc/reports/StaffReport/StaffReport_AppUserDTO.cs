...
{
    public class StaffReport_AppUserDTO : DataDTO
    {
        ...
        public StaffReport_AppUserDTO() {}
        public StaffReport_AppUserDTO(AppUser AppUser)
        {
    ...
    public class StaffReport_AppUserFilterDTO : FilterDTO
    {
