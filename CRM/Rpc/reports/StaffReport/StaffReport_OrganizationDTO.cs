...
{
    public class StaffReport_OrganizationDTO : DataDTO
    {
        ...
        public StaffReport_OrganizationDTO() {}
        public StaffReport_OrganizationDTO(Organization Organization)
        {
    ...
    public class StaffReport_OrganizationFilterDTO : FilterDTO
    {
