...
{
    public class DashboardManager_AppUserDTO : DataDTO
    {
        ...
        public DashboardManager_AppUserDTO() {}
        public DashboardManager_AppUserDTO(AppUser AppUser)
        {
    ...
    public class DashboardManager_AppUserFilterDTO : FilterDTO
    {
