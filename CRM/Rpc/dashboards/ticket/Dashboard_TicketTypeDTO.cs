...
{
    public class Dashboard_TicketTypeDTO : DataDTO
    {
        ...
        public Dashboard_TicketTypeDTO() {}
        public Dashboard_TicketTypeDTO(TicketType TicketType)
        {
    ...
    public class Dashboard_TicketTypeFilterDTO : FilterDTO
    {
