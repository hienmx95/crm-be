...
namespace CRM.Rpc.direct_sales_order
{
    public class DirectSalesOrder_UnitOfMeasureDTO : DataDTO , IEquatable<DirectSalesOrder_UnitOfMeasureDTO>
    {
        ...
        public DirectSalesOrder_UnitOfMeasureDTO(UnitOfMeasureGroupingContent UnitOfMeasureGroupingContent)
        {
            ...
            this.Code = UnitOfMeasureGroupingContent.UnitOfMeasure?.Code;

            this.Name = UnitOfMeasureGroupingContent.UnitOfMeasure?.Name;

            this.Description = UnitOfMeasureGroupingContent.UnitOfMeasure?.Description;
