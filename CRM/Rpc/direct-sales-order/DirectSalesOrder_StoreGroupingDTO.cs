...
{
    public class DirectSalesOrder_StoreGroupingDTO : DataDTO
    {
        ...
        public DirectSalesOrder_StoreGroupingDTO() { }
    ...
    public class DirectSalesOrder_StoreGroupingFilterDTO : FilterDTO
    {
