...
{
    public class DirectSalesOrder_WardDTO : DataDTO
    {
        ...
        public DirectSalesOrder_WardDTO() {}
        public DirectSalesOrder_WardDTO(Ward Ward)
        {
    ...
    public class DirectSalesOrder_WardFilterDTO : FilterDTO
    {
