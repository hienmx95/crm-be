...
{
    public class AppUser_OrganizationDTO : DataDTO
    {
        ...
        public AppUser_OrganizationDTO() { }
        public AppUser_OrganizationDTO(Organization Organization)
        {
    ...
    public class AppUser_OrganizationFilterDTO : FilterDTO
    {
