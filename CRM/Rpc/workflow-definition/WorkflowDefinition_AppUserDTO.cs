...
{
    public class WorkflowDefinition_AppUserDTO : DataDTO
    {
        ...
        public WorkflowDefinition_AppUserDTO() { }
        public WorkflowDefinition_AppUserDTO(AppUser AppUser)
        {
    ...
    public class WorkflowDefinition_AppUserFilterDTO : FilterDTO
    {
