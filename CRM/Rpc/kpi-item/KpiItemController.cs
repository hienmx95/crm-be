...
using CRM.Services.MKpiCriteriaItem;
using CRM.Services.MKpiItem;
using CRM.Services.MKpiItemContent;
...
namespace CRM.Rpc.kpi_item
{
    public class KpiItemController : RpcController
    {
        ...
        public async Task<ActionResult> Import([FromForm] IFormFile file)
        {
            ...
            using (ExcelPackage excelPackage = new ExcelPackage(file.OpenReadStream()))
            {
                ...
                for (int i = StartRow; i <= worksheet.Dimension.End.Row; i++)
                {
                    ...
                    KpiItem_ImportDTO.OrderOutput = worksheet.Cells[i, QuantityColumn].Value?.ToString();
                    KpiItem_ImportDTO.Sales = worksheet.Cells[i, RevenueColumn].Value?.ToString();
                    KpiItem_ImportDTO.OrderNumber = worksheet.Cells[i, SaleOrderColumn].Value?.ToString();
                    KpiItem_ImportDTO.NumberOfCustomer = worksheet.Cells[i, StoreColumn].Value?.ToString();
            ...
            foreach (var KpiItem_ImportDTO in KpiItem_ImportDTOs)
            {
                ...
                if (KpiItemContent != null)
                {
                    ...
                    {
                        if (long.TryParse(KpiItem_ImportDTO.OrderOutput, out long OrderOutput) && KpiItemContentKpiCriteriaItemMapping.KpiCriteriaItemId == KpiCriteriaItemEnum.ORDER_OUTPUT.Id)
                        {
                            KpiItemContentKpiCriteriaItemMapping.Value = OrderOutput;
                        }
                        else if (long.TryParse(KpiItem_ImportDTO.Sales, out long Sales) && KpiItemContentKpiCriteriaItemMapping.KpiCriteriaItemId == KpiCriteriaItemEnum.SALES.Id)
                        {
                            KpiItemContentKpiCriteriaItemMapping.Value = Sales;
                        }
                        else if (long.TryParse(KpiItem_ImportDTO.OrderNumber, out long OrderNumber) && KpiItemContentKpiCriteriaItemMapping.KpiCriteriaItemId == KpiCriteriaItemEnum.ORDER_NUMBER.Id)
                        {
                            KpiItemContentKpiCriteriaItemMapping.Value = OrderNumber;
                        }
                        else if (long.TryParse(KpiItem_ImportDTO.NumberOfCustomer, out long NumberOfCustomer) && KpiItemContentKpiCriteriaItemMapping.KpiCriteriaItemId == KpiCriteriaItemEnum.NUMBER_OF_CUSTOMER.Id)
                        {
                            KpiItemContentKpiCriteriaItemMapping.Value = NumberOfCustomer;
                        }
                    }
                }
        ...
        public async Task<ActionResult> Export([FromBody] KpiItem_KpiItemFilterDTO KpiItem_KpiItemFilterDTO)
        {
            ...
            List<KpiItem_KpiItemDTO> KpiItem_KpiItemDTOs = await ListKPIItem(KpiItem_KpiItemFilterDTO);
            ...
            foreach (var KpiItem in KpiItem_KpiItemDTOs)
            {
                ...
                KpiItem_ExportDTO.Contents = KpiItemContents.Where(x => x.KpiItemId == KpiItem.Id).Select(x => new KpiItem_ExportContentDTO
                {
                    ...
                    .Where(x => x.KpiCriteriaItemId == KpiCriteriaItemEnum.ORDER_OUTPUT.Id)
                    .Where(x => x.Value.HasValue)
                    .Select(x => x.Value.Value)
                    .Sum(),
                    IndirectRevenue = x.KpiItemContentKpiCriteriaItemMappings
                    .Where(x => x.KpiCriteriaItemId == KpiCriteriaItemEnum.SALES.Id)
                    .Where(x => x.Value.HasValue)
                    .Select(x => x.Value.Value)
                    .Sum(),
                    IndirectCounter = x.KpiItemContentKpiCriteriaItemMappings
                    .Where(x => x.KpiCriteriaItemId == KpiCriteriaItemEnum.ORDER_NUMBER.Id)
                    .Where(x => x.Value.HasValue)
                    .Select(x => x.Value.Value)
                    .Sum(),
                    IndirectStoreCounter = x.KpiItemContentKpiCriteriaItemMappings
                    .Where(x => x.KpiCriteriaItemId == KpiCriteriaItemEnum.NUMBER_OF_CUSTOMER.Id)
                    .Where(x => x.Value.HasValue)
                    .Select(x => x.Value.Value)
                    .Sum(),
                }).ToList();
        ...
        public async Task<ActionResult<List<KpiItem_AppUserDTO>>> FilterListAppUser([FromBody] KpiItem_AppUserFilterDTO KpiItem_AppUserFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiItem_AppUserDTO>>> FilterListCreator([FromBody] KpiItem_AppUserFilterDTO KpiItem_AppUserFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiItem_KpiPeriodDTO>>> FilterListKpiPeriod([FromBody] KpiItem_KpiPeriodFilterDTO KpiItem_KpiPeriodFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiItem_KpiYearDTO>>> FilterListKpiYear([FromBody] KpiItem_KpiYearFilterDTO KpiItem_KpiYearFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiItem_OrganizationDTO>>> FilterListOrganization([FromBody] KpiItem_OrganizationFilterDTO KpiItem_OrganizationFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiItem_StatusDTO>>> FilterListStatus()
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiItem_KpiCriteriaItemDTO>>> FilterListKpiCriteriaItem()
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiItem_ItemDTO>>> FilterListItem([FromBody] KpiItem_ItemFilterDTO KpiItem_ItemFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiItem_SupplierDTO>>> FilterListSupplier([FromBody] KpiItem_SupplierFilterDTO KpiItem_SupplierFilterDTO)
        {
            if (UnAuthorization) return Forbid();
        ...
        public async Task<ActionResult<List<KpiItem_ProductTypeDTO>>> FilterListProductType([FromBody] KpiItem_ProductTypeFilterDTO KpiItem_ProductTypeFilterDTO)
        {
            if (UnAuthorization) return Forbid();
        ...
        public async Task<ActionResult<List<KpiItem_ProductGroupingDTO>>> FilterListProductGrouping([FromBody] KpiItem_ProductGroupingFilterDTO KpiItem_ProductGroupingFilterDTO)
        {
            if (UnAuthorization) return Forbid();
        ...
        public async Task<ActionResult<List<KpiItem_AppUserDTO>>> SingleListAppUser([FromBody] KpiItem_AppUserFilterDTO KpiItem_AppUserFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiItem_KpiPeriodDTO>>> SingleListKpiPeriod([FromBody] KpiItem_KpiPeriodFilterDTO KpiItem_KpiPeriodFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiItem_KpiYearDTO>>> SingleListKpiYear([FromBody] KpiItem_KpiYearFilterDTO KpiItem_KpiYearFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiItem_OrganizationDTO>>> SingleListOrganization([FromBody] KpiItem_OrganizationFilterDTO KpiItem_OrganizationFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiItem_StatusDTO>>> SingleListStatus()
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiItem_KpiCriteriaItemDTO>>> SingleListKpiCriteriaItem()
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<List<KpiItem_ItemDTO>>> SingleListItem([FromBody] KpiItem_ItemFilterDTO KpiItem_ItemFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<ActionResult<long>> CountAppUser([FromBody] KpiItem_AppUserFilterDTO KpiItem_AppUserFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            AppUserFilter AppUserFilter = new AppUserFilter();
            AppUserFilter.Id = KpiItem_AppUserFilterDTO.Id;
        ...
        public async Task<ActionResult<List<KpiItem_AppUserDTO>>> ListAppUser([FromBody] KpiItem_AppUserFilterDTO KpiItem_AppUserFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            AppUserFilter AppUserFilter = new AppUserFilter();
        ...
        public async Task<ActionResult<long>> CountItem([FromBody] KpiItem_ItemFilterDTO KpiItem_ItemFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            ItemFilter ItemFilter = new ItemFilter();
            ItemFilter.Code = KpiItem_ItemFilterDTO.Code;
        ...
        public async Task<ActionResult<List<KpiItem_ItemDTO>>> ListItem([FromBody] KpiItem_ItemFilterDTO KpiItem_ItemFilterDTO)
        {
            if (UnAuthorization) return Forbid();
            ItemFilter ItemFilter = new ItemFilter();
        ...
        private async Task<List<KpiItem_KpiItemDTO>> ListKPIItem([FromBody] KpiItem_KpiItemFilterDTO KpiItem_KpiItemFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
