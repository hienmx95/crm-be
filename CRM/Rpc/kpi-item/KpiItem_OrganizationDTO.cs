...
{
    public class KpiItem_OrganizationDTO : DataDTO
    {
        ...
        public KpiItem_OrganizationDTO() { }
        public KpiItem_OrganizationDTO(Organization Organization)
        {
    ...
    public class KpiItem_OrganizationFilterDTO : FilterDTO
    {
