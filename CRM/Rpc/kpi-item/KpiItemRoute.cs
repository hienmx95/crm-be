    ...
    public class KpiItemRoute : Root
    {
        ...
        public static Dictionary<string, List<string>> Action = new Dictionary<string, List<string>>
        {
            { "Tìm kiếm", new List<string> {
                ...
                FilterListAppUser, FilterListCreator, FilterListKpiPeriod,FilterListKpiYear, FilterListOrganization, FilterListStatus, FilterListKpiItemContent, FilterListItem, FilterListKpiCriteriaItem, FilterListProductGrouping, FilterListProductType, FilterListSupplier} },
            ...
            { "Thêm", new List<string> {
                ...
                SingleListAppUser, SingleListKpiPeriod, SingleListKpiYear, SingleListOrganization, SingleListStatus, SingleListKpiItemContent, SingleListItem, SingleListKpiCriteriaItem, } },
