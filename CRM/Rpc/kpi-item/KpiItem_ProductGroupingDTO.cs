...
{
    public class KpiItem_ProductGroupingDTO : DataDTO
    {
        ...
        public KpiItem_ProductGroupingDTO() { }
        public KpiItem_ProductGroupingDTO(ProductGrouping ProductGrouping)
        {
    ...
    public class KpiItem_ProductGroupingFilterDTO : FilterDTO
    {
