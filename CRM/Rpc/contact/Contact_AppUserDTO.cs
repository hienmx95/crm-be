...
{
    public class Contact_AppUserDTO : DataDTO
    {
        ...
        public Contact_AppUserDTO() {}
        public Contact_AppUserDTO(AppUser AppUser)
        {
    ...
    public class Contact_AppUserFilterDTO : FilterDTO
    {
