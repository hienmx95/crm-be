...
{
    public class Contact_CustomerDTO : DataDTO
    {
        ...
        public Contact_CustomerDTO() {}
        public Contact_CustomerDTO(Customer Customer)
        {
    ...
    public class Contact_CustomerFilterDTO : FilterDTO
    {
