...
{
    public class Contact_CompanyDTO : DataDTO
    {
        ...
        public Contact_CompanyDTO() { }
        public Contact_CompanyDTO(Company Company)
        {
    ...
    public class Contact_CompanyFilterDTO : FilterDTO
    {
