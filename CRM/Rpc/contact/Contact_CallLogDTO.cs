...
{
    public class Contact_CallLogDTO : DataDTO
    {
        ...
        public Contact_CallEmotionDTO CallEmotion { get; set; }
        public Contact_CallTypeDTO CallType { get; set; }
        public Contact_AppUserDTO Creator { get; set; }
        public Contact_EntityReferenceDTO EntityReference { get; set; }
        public DateTime CreatedAt { get; set; }
        public DateTime UpdatedAt { get; set; }
        public Contact_CallLogDTO() { }
        public Contact_CallLogDTO(CallLog CallLog)
        {
            this.Id = CallLog.Id;
            ...
            this.AppUser = CallLog.AppUser == null ? null : new Contact_AppUserDTO(CallLog.AppUser);
            this.CallEmotion = CallLog.CallEmotion == null ? null : new Contact_CallEmotionDTO(CallLog.CallEmotion);
            this.CallType = CallLog.CallType == null ? null : new Contact_CallTypeDTO(CallLog.CallType);
            this.Creator = CallLog.Creator == null ? null : new Contact_AppUserDTO(CallLog.Creator);
            this.EntityReference = CallLog.EntityReference == null ? null : new Contact_EntityReferenceDTO(CallLog.EntityReference);
    ...
    public class Contact_CallLogFilterDTO : FilterDTO
    {
