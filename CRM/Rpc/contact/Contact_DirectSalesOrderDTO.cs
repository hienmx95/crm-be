...
{
    public class Contact_DirectSalesOrderDTO : DataDTO
    {
        ...
        public Contact_DirectSalesOrderDTO() { }
        public Contact_DirectSalesOrderDTO(DirectSalesOrder DirectSalesOrder)
        {
    ...
    public class Contact_DirectSalesOrderFilterDTO : FilterDTO
    {
