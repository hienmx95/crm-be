...
{
    public class Contact_ProductTypeDTO : DataDTO
    {
        ...
        public Contact_ProductTypeDTO() {}
        public Contact_ProductTypeDTO(ProductType ProductType)
        {
    ...
    public class Contact_ProductTypeFilterDTO : FilterDTO
    {
