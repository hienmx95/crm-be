...
{
    public class Contact_UnitOfMeasureDTO : DataDTO
    {
        ...
        public Contact_UnitOfMeasureDTO() {}
        public Contact_UnitOfMeasureDTO(UnitOfMeasureGroupingContent UnitOfMeasureGroupingContent)
        {
        ...
        public Contact_UnitOfMeasureDTO(UnitOfMeasure UnitOfMeasure)
        {
    ...
    public class Contact_UnitOfMeasureFilterDTO : FilterDTO
    {
