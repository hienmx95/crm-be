...
{
    public class Contact_SupplierDTO : DataDTO
    {
        ...
        public Contact_SupplierDTO() {}
        public Contact_SupplierDTO(Supplier Supplier)
        {
    ...
    public class Contact_SupplierFilterDTO : FilterDTO
    {
