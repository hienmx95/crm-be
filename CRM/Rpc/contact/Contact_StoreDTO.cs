...
{
    public class Contact_StoreDTO : DataDTO
    {
        ...
        public Contact_StoreDTO ParentStore { get; set; }
        public Contact_StoreDTO() { }
        public Contact_StoreDTO(Store Store)
        {
            ...
            this.ParentStore = Store.ParentStore == null ? null : new Contact_StoreDTO(Store.ParentStore);
            this.Errors = Store.Errors;
        }
    }

    public class Contact_StoreFilterDTO : FilterDTO
    {
