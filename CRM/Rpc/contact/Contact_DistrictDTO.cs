...
{
    public class Contact_DistrictDTO : DataDTO
    {
        ...
        public Contact_DistrictDTO() {}
        public Contact_DistrictDTO(District District)
        {
    ...
    public class Contact_DistrictFilterDTO : FilterDTO
    {
