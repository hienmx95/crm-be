...
{
    public class Contact_TaxTypeDTO : DataDTO
    {
        ...
        public Contact_TaxTypeDTO() {}
        public Contact_TaxTypeDTO(TaxType TaxType)
        {
    ...
    public class Contact_TaxTypeFilterDTO : FilterDTO
    {
