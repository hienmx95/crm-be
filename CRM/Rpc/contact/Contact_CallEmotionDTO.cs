...
{
    public class Contact_CallEmotionDTO : DataDTO
    {
        ...
        public Contact_CallEmotionDTO() {}
        public Contact_CallEmotionDTO(CallEmotion CallEmotion)
        {
    ...
    public class Contact_CallEmotionFilterDTO : FilterDTO
    {
