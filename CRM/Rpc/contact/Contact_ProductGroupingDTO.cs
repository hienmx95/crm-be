...
{
    public class Contact_ProductGroupingDTO : DataDTO
    {
        ...
        public Contact_ProductGroupingDTO() { }
        public Contact_ProductGroupingDTO(ProductGrouping ProductGrouping)
        {
    ...
    public class Contact_ProductGroupingFilterDTO : FilterDTO
    {
