...
{
    public class SLAEscalationFRT : DataEntity,  IEquatable<SLAEscalationFRT>
    {
        ...
        public List<SLAEscalationFRTMail> SLAEscalationFRTMails { get; set; }
        public List<SLAEscalationFRTPhone> SLAEscalationFRTPhones { get; set; }
        public List<SLAEscalationFRTUser> SLAEscalationFRTUsers { get; set; }
        public DateTime CreatedAt { get; set; }
        public DateTime UpdatedAt { get; set; }

        public bool Equals(SLAEscalationFRT other)
        {
    ...
    public class SLAEscalationFRTFilter : FilterEntity
    {
        ...
        public List<SLAEscalationFRTFilter> OrFilter { get; set; }
        public SLAEscalationFRTOrder OrderBy {get; set;}
        public SLAEscalationFRTSelect Selects {get; set;}
    }

    [JsonConverter(typeof(StringEnumConverter))]
    public enum SLAEscalationFRTOrder
    {
        Id = 0,
        TicketIssueLevel = 1,
        IsNotification = 2,
    ...
    [Flags]
    public enum SLAEscalationFRTSelect:long
    {
        ALL = E.ALL,
        Id = E._0,
