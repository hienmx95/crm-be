...
{
    public class SLAAlertFRT : DataEntity,  IEquatable<SLAAlertFRT>
    {
        ...
        public List<SLAAlertFRTMail> SLAAlertFRTMails { get; set; }
        public List<SLAAlertFRTPhone> SLAAlertFRTPhones { get; set; }
        public List<SLAAlertFRTUser> SLAAlertFRTUsers { get; set; }
        public DateTime CreatedAt { get; set; }
        public DateTime UpdatedAt { get; set; }

        public bool Equals(SLAAlertFRT other)
        {
    ...
    public class SLAAlertFRTFilter : FilterEntity
    {
        ...
        public List<SLAAlertFRTFilter> OrFilter { get; set; }
        public SLAAlertFRTOrder OrderBy {get; set;}
        public SLAAlertFRTSelect Selects {get; set;}
    }

    [JsonConverter(typeof(StringEnumConverter))]
    public enum SLAAlertFRTOrder
    {
        Id = 0,
        TicketIssueLevel = 1,
        IsNotification = 2,
    ...
    [Flags]
    public enum SLAAlertFRTSelect:long
    {
        ALL = E.ALL,
        Id = E._0,
